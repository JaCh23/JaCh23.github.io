...
## 3.2. A Possible Bayesian Modelling Approach
...
- Cumulative Knowledge ($K$): The total information possessed by the Seekers at and up to turn $N$ is represented by the set of all observed evidence, as part of the question-answer pairs, collected.

This can be represented as:$$K_N = \bigcup_{i=1}^{N} E_i$$
Where:
